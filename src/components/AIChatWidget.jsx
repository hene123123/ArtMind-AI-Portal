...
export default function AIChatWidget() {
  ...
  const [messages, setMessages] = useState([
    {
      sender: 'ai',
      text: 'Xin chào! Tôi là **ArtMind AI** 🎨. Hỏi mình về tranh, trường phái, gợi ý tác phẩm, tạo prompt vẽ AI… hoặc bất kỳ kiến thức nào khác nhé!'
    }
  ]);
          ...
          <div className="bg-slate-800 border-b border-slate-700 p-4 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Trợ lý AI đa năng · nghệ thuật & kiến thức</p>
              </div>
            </div>
            <button
